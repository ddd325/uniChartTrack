...
custom_headers = c("Accept" = "*/*",
                   ...
                   "Referer" = "https://yobang.tencentmusic.com/chart/uni-chart/detail/?uniId=247595559",
...
url <- "https://yobang.tencentmusic.com/unichartsapi/v1/songs/247595559/charts_detail"
...
if (http_status(response)$category == "Success") {
  ...
  write.table(out_data, "data/Song3.csv", 
